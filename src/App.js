...
//       <button className='save-node-button' onClick={isAllNodesAreConnected}>Save Changes</button>
//     </div>
//     <div className='main-container'>
//       <div className='reactflow-container' onClick={removeActiveClass}>
//         <ReactFlow
...
//         {showEditMessage ?
//           <>
//             <div className='edit-message-header'><button className='back-button' onClick={backButtonClick} >
//               <IoArrowBack />
//             </button>
//               <div style={{ marginLeft: '25%' }}>Message</div></div>
//             <div className='edit-message'>

//               <div>Text</div>

//               <textarea ref={textareaRef} className='edit-message-textarea' placeholder='Enter your message here' onChange={handleTextareaChange}  ></textarea>
//             </div>
